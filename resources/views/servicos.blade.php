...
<head>
    <meta charset="utf-8">
    <title>Imperagro - Serviços e Soluções</title>
    ...
    <link rel="stylesheet" href="{{ asset('site/css/servico.css') }}">
...
<section class="servicos" id="servicos">
    <div class="content">
        <div class="row cabecalho">
            <h2>SERVIÇOS E SOLUÇOES</h2>
            <h3 class="emphasys">{{ $servico_titulo }}</h3>
        </div>
        <div class="row">
            <div class="content">
                {!! $servico_conteudo !!}
